...
| Badge de status | Pill colorida no canto superior direito do card |
...
├── fluxos-de-jornada-do-usuario.md ← Fluxos de tela em texto estruturado
└── ...
```
...
├── decisoes-arquiteturais-core.md    ← Todas as decisões em tabelas
├── estrutura-do-projeto-limites.md  ← Árvore completa de diretórios
├── padroes-de-implementacao...md       ← Regras que o Dev deve seguir
└── resultados-da-validacao...md       ← Checklist de completude
```
...
Em qualquer ponto do processo, você pode ativar o **Party Mode** para reunir todos os agentes e discutir um problema juntos. Cada agente vai contribuir a partir da sua perspectiva.
